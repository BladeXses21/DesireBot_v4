...
class PassCloseFromEventMode(object):
    def __init__(self, clan_name: str, clan_name_two: str, win_clan: str, event_name: str, event_mode, interaction, comment: str):
        self._embed = Embed(
            title=f'Ивент был успешно завершен.',
            description=f'***```{event_mode}, проводил ивент```***',
        ...
        self._embed.add_field(name='Победивший', value=f'***```{win_clan}```***')
